-- Enhanced slug generation function with title, city, country format
...
-- Update the trigger function to pass location to slug generation
...
-- Regenerate all existing slugs with the new format
UPDATE public.audio_guides 
SET slug = public.generate_slug(title, location)
