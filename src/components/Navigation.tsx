...
export const Navigation = ({ sticky = true }: NavigationProps) => {
  ...
  return (
    <header className={`${sticky ? 'sticky top-0' : 'relative'} z-50 w-full border-b border-border/30 bg-background/95 backdrop-blur-2xl supports-[backdrop-filter]:bg-background/60`}>
