  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-manipulation",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground btn-raised hover:shadow-glow transform hover:scale-105 active:scale-[0.98] active:translate-y-[1px] transition-bounce",
        audio: "bg-gradient-accent text-accent-foreground btn-raised hover:shadow-accent-glow transform hover:scale-105 active:scale-[0.98] active:translate-y-[1px] transition-bounce",
        ...
        tourism: "bg-gradient-tourism text-primary-foreground btn-raised hover:shadow-tourism transform hover:scale-105 active:scale-[0.98] active:translate-y-[1px] transition-bounce",
        ocean: "bg-gradient-ocean text-accent-foreground btn-raised hover:shadow-accent-glow transform hover:scale-105 active:scale-[0.98] active:translate-y-[1px] transition-bounce",
        sunset: "bg-gradient-sunset text-primary-foreground btn-raised hover:shadow-glow transform hover:scale-105 active:scale-[0.98] active:translate-y-[1px] transition-bounce",
      },
      size: {
