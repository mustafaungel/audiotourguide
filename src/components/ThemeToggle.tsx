  ...
  return (
    ...
    >
      ...
      <span
        ...
        aria-hidden="true"
      >
        <span className="absolute left-2 top-1.5 h-[2px] w-[2px] rounded-full bg-white" />
        <span className="absolute left-3.5 top-3 h-[1.5px] w-[1.5px] rounded-full bg-white/80" />
        <span className="absolute left-2.5 top-5 h-[1.5px] w-[1.5px] rounded-full bg-white/60" />
      </span>

      {/* Cloud (light mode) */}
      <span
        className={cn(
          "pointer-events-none absolute right-1.5 top-1/2 -translate-y-1/2 transition-opacity duration-500",
      ...
      <span
        className={cn(
          "relative z-10 flex h-[26px] w-[26px] items-center justify-center rounded-full bg-white",
      ...
      >
        <Sun
          className={cn(
            "absolute h-[14px] w-[14px] text-amber-500 transition-all duration-300",
            isDark ? "rotate-90 scale-0 opacity-0" : "rotate-0 scale-100 opacity-100"
          )}
        />
        <Moon
          className={cn(
            "absolute h-[14px] w-[14px] text-slate-700 transition-all duration-300",
