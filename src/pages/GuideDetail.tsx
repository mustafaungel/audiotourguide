...
const GuideDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-14 sm:top-16 z-40 bg-background/95 backdrop-blur-md border-b border-border/30 px-2 py-1.5">
        <div className="flex items-center gap-1">
          <button onClick={() => navigate('/guides')} className="p-1 shrink-0 text-muted-foreground">
            <ChevronLeft className="w-4 h-4" />
          </button>
          <Headphones className="w-3 h-3 text-primary shrink-0" />
          <span className="text-xs font-bold font-heading flex-1 min-w-0 truncate">{guide.title}</span>
