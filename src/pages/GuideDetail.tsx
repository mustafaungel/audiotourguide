...
const GuideDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className={`sticky top-14 sm:top-16 z-40 backdrop-blur-xl border-b border-border/30 px-3 py-2 ${isFeaturedGuide ? '<div className={`sticky top-14 sm:top-16 z-40 backdrop-blur-xl border-b border-border/30 px-3 py-2 ${isFeaturedGuide ? 'bg-amber-900/40 dark:bg-amber-950/50' : 'bg-background/70'}`}>' : 'bg-background/70'}`}>
