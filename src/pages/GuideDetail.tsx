...
const GuideDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className={`sticky top-14 sm:top-16 z-40 backdrop-blur-md border-b border-border/30 px-3 py-2 ${isFeaturedGuide ? 'bg-amber-950/95 dark:bg-amber-950/95' : 'bg-background'}`}>
